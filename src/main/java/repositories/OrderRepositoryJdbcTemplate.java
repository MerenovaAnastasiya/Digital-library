...
public class OrderRepositoryJdbcTemplate implements OrderRepository {
    ...
    public OrderRepositoryJdbcTemplate(Connection connection) {
    ...
    public Optional<Order> findOne(Long id) {
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(SQL_SELECT_ORDER_WITH_BOOKS);
    ...
    @Override
    public void findAllBooks(Long id) {
    }
